    ...
    "container_specific":
      ...
      rules:
        ...
        - name: 'allow docker api vrack'
          ...
          chain: 'CONTAINER'
          family: 'ip'
          rule: 'ip saddr 10.3.0.0/16 tcp dport 2375 counter accept'
        ...
        - name: 'allow swarm vrack'
          ...
          chain: 'CONTAINER'
          family: 'ip'
          rule: 'ip saddr 10.3.0.0/16 tcp dport 2377 counter accept'
        - name: 'allow swarm'
          table: 'filter'
          chain: 'CONTAINER'
          family: 'ip6'
        ...
        - name: 'allow swarm network tcp'
          ...
          chain: 'CONTAINER'
          family: 'ip'
          rule: 'ip saddr 10.3.0.0/24 tcp dport 7946 counter accept'
        - name: 'allow swarm network tcp'
          table: 'filter'
          chain: 'CONTAINER'
          family: 'ip6'
        ...
        - name: 'allow swarm network udp'
          ...
          chain: 'CONTAINER'
          family: 'ip'
          rule: 'ip saddr 10.3.0.0/16 udp dport 4789 counter accept'
        - name: 'allow swarm network udp'
          table: 'filter'
          chain: 'CONTAINER'
          family: 'ip6'
        ...
        - name: 'allow swarm glusterfs vrack'
          ...
          chain: 'CONTAINER'
          family: 'ip'
          rule: 'ip saddr 10.3.0.0/16 tcp dport {24007-24009,49152-49200} counter accept'
