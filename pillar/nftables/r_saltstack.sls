  ...
  configuration:
    "saltstack_specific":
      ...
      rules:
        ...
        - name: 'allow saltstack api'
          table: 'filter'
          chain: 'saltstack'
          family: 'ip'
          rule: 'tcp dport 3333 ip saddr { 10.0.0.1/16 }counter accept'
        - name: 'allow salt exporter prometheus scraping'
          table: 'filter'
          chain: 'prometheus'
          family: 'ip'
          rule: 'tcp dport { 9105 } ip saddr { 10.0.3.197/32, 51.178.63.140/32 } counter accept'
